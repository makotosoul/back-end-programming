...
@ComponentScan(basePackages = { "backend.thiennguyen.bookmark", "backend.thiennguyen.web",
		"backend.thiennguyen.domain" })
public class BookmarkApplication {
	...
	@Bean
	public CommandLineRunner demo(ProjectRepository Prepository, WebsiteRepository repository,
		...
		return (args) -> {
			...
			// Projects
			Project pro1 = new Project("backend project");
			Project pro2 = new Project("random project");
			Prepository.save(pro1);
			Prepository.save(pro2);

			// website data
			Website web1 = new Website("github", "https://github.com/", "for uploading project!", pro1);
			Website web2 = new Website("moodle", "https://hhmoodle.haaga-helia.fi/my/index.php?lang=en","for submitting homework", pro2);
			Website web3 = new Website("youtube", "https://www.youtube.com/", "for watching clips", pro2);
